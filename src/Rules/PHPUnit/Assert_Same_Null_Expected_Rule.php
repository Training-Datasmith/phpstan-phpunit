 ...
 */
class Assert_Same_Null_Expected_Rule implements Rule
{
    ...
    public function process_node(Node $node, Scope $scope): array
    {
        ...
        if ($expected_argument_value->name->to_lower_string() === 'null') {
            return [Rule_Error_Builder::message('You should use assertNull() instead of assertSame(null, $actual).')->identifier('phpunit.assertNull')->fix_node($node, static function (Call_Like $node) {
